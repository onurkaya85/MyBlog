            ...
            $.post(actionUrl, dataToSend).done(function (data) {
                ...
                if (isValid) {
                    const newSingleComment = `  <div class="media mb-4">
                         <img class="d-flex mr-3 rounded-circle" src="https://randomuser.me/api/portraits/women/60.jpg" alt="">
                    ...
                    toastr.success(`Sayın ${commentAddAjaxModel.CommentDto.Comment.CreatedByName}, 
                      yorumunuz başarıyla eklenmiştir.Bir Örneği sizler için karşınıza gelecektir.
                      Fakat yorumunuz onaylandıktan sonra görünür olacaktır.`);
