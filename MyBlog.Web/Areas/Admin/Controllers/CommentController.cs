...
namespace MyBlog.Web.Areas.Admin.Controllers
{
    ...
    public class CommentController : BaseController
    {
        ...
        {
            var result = await _commentService.DeleteAsync(commentId, LoggedUser.UserName);
        ...
        {
            var result = await _commentService.AproveAsync(commentId, LoggedUser.UserName);
            var commentResult = JsonSerializer.Serialize(result, new JsonSerializerOptions
            {
                ReferenceHandler = ReferenceHandler.Preserve
            });
        ...
        public async Task<IActionResult> Update(CommentUpdateDto commentUpdateDto)
        {
            ...
            {
                var result = await _commentService.UpdateAsync(commentUpdateDto, LoggedUser.UserName);
                if (result.ResultStatus == ResultStatus.Success)
                {
        ...
        {
            var result = await _commentService.UndoDeleteAsync(commentId, LoggedUser.UserName);
