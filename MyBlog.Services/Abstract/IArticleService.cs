...
namespace MyBlog.Services.Abstract
{
    public interface IArticleService
    {
        ...
        Task<IDataResult<ArticleListDto>> GetAllAsyncV2(int? categoryId,int? userId,bool? isActive,bool? isDeleted, int? currentPage
            ,int? pageSize,OrderByGeneral? orderBy,bool? isAcsending, bool includeCategory, bool includeComments, bool includeUser);
        ...
        Task<IDataResult<ArticleListDto>> GetAllByUserIdOnFilter(int userId, FilterBy filterBy,OrderBy orderBy,bool isAcsending,int takeSize,
